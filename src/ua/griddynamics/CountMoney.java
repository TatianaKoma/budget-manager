...
public class CountMoney {
    ...
    static void routine(Scanner scanner) throws IOException {
        while (!quit) {
            menu();
            ...
            switch (choice) {
                ...
                case 6:
                    ...
                    break;
                case 7:
                    Purchase.sortPurchasesFromMainMenu(scanner);
                    break;
                case 0:
                    quit = true;
                    System.out.println("\nBye!");
                    ...
                    FileOutputStream writer = new FileOutputStream("purchases.txt");
